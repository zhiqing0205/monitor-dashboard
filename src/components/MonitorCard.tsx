...
export default function MonitorCard({ status }: MonitorCardProps) {
  const { balance, expiry, total, displayUnit, decimals = 2, status: currentStatus, error } = status;
  ...
  return (
    <div className={`p-6 rounded-xl border-2 ${getStatusColor()} backdrop-blur-sm transition-all duration-200 relative shadow-lg hover:shadow-xl`}>
